# most of the code is borrowed from: https://gist.github.com/douglasrizzo/cd7e792ff3a2dcaf27f6
import numpy as np
...
def dunn_score(X, labels, diameter_method='farthest',
               cdist_method='nearest',
    ...
    distances = pairwise_distances(X=X, metric=metric, **kwds)
